...
require("../images/products/product-01 (1).png");
const product_01_image_02 =
  require("../images/products/product-01 (2).png");
...
//     price: "189000",
//     image01: require("../images/products/product-01 (1).png"),
...
//   {
//    const res =  axios.get(`/api/view-product`).then(res => res.data.products);
//     return  res 
//   }
  
// const a = asyn =>{axios.get(`/api/view-product`).then((res) => {
//   if (res.status === 200) {
